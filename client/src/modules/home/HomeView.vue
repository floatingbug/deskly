  ...
  <div class="home">
    ...
    <section class="host-cta">
      <div class="host-cta__content">
        ...
        <p class="host-cta__text">Earn by listing your office or meeting space. It only takes a minute to get started.</p>
        <Button
          label="Add a space"
          icon="pi pi-plus"
          size="small"
          @click="navigateToAddSpace"
        />
      </div>
    </section>
  </div>
...
.hero {
  ...
  background: linear-gradient(
    180deg,
    hsl(from var(--p-primary-800) h s calc(l + 5) / 18%) 0%,
    transparent 100%
  );
}
