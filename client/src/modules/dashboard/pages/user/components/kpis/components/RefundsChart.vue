...
function setChartData() {
	...
	const completedColor = getComputedStyle(document.documentElement).getPropertyValue("--bg-primary-light-dark");
	const canceledColor = getComputedStyle(document.documentElement).getPropertyValue("--p-orange-500");
