...
const { pastBookings, selectedBooking } = useBookingStore();
...
<template>
    <BookingsLayout>
        <template #header>Past Bookings</template>

        <template #main>
            <BookingLayout v-for="(booking, index) in pastBookings" @click="manageBooking(booking)">
                <template #booking>
                    <BookingItemLayout>
