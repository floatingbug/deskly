...
const { futureBookings, selectedBooking } = useBookingStore();
...
<template>
    <BookingsLayout>
        <template #header>Future Bookings</template>

        <template #main>
            <BookingLayout v-for="(booking, index) in futureBookings" @click="manageBooking(booking)">
                <template #booking>
                    <BookingItemLayout>
