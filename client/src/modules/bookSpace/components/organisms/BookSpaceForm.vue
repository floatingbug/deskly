		...
		<div class="booking-status__container">
			...
			<div class="booking-status">
				<div class="booking-status__item">
					<div class="booking-status__item-label">Total Hours:</div>
				...
				<div class="booking-status__item">
					<div class="booking-status__item-label">Total Amount:</div>

					<div class="booking-status__item-value">{{ bookingStatus.totalAmount }}$</div>
				</div>
			</div>
		</div>
